              ...
              <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      onVariantFieldChange(vIndex, 'actualPrice', parseFloat(e.target.value) || 0)
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      onVariantFieldChange(vIndex, 'finalPrice', parseFloat(e.target.value) || 0)
                    }
                    className="w-full rounded-lg border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      onVariantFieldChange(vIndex, 'stockQuantity', parseInt(e.target.value) || 0)
                    }
                    className="w-full rounded-lg border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-blue-500"
                  />
                </div>
          ...
          >
            <Trash2 className="h-4 w-4" />
              ...
              <div className="mt-4 space-y-3">
                ...
                {/* Meta Keywords */}
                <div>
                  <label className="mb-1 block text-sm font-medium text-gray-700">Variant Meta Keywords</label>
